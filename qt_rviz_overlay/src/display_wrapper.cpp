...
//  {
//  }
  overlay_ =  std::make_shared<Overlay>(node, context_->getSceneManager(), context_->getViewManager()->getRenderPanel());
...
PLUGINLIB_EXPORT_CLASS( qt_rviz_overlay::DisplayWrapper, rviz::Display )
